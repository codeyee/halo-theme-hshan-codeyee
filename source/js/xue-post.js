...
var post = {
    ...
    initToc: function () {
        ...
        tocbot.init({
            ...
            scrollSmooth: true,
            headingsOffset: 0 - $('#postHeader').height() + 600, //Xue目录迁移到Hshan需要增加顶部的偏移量
            scrollSmoothOffset: -65, // 实现点击目录精准跳转到header
...
$(function () {
    ...
    // 图片预览
    post.initViewer();
    console.log("xue-postjs")
    console.log(openToc)
    if (openToc) {
        console.log("Xue主题开始生成目录")
